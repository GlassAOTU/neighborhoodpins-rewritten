        ...
        <nav className="text-white bg-emerald-800 px-5 py-3">
            <div className="flex flex-row justify-between">
                ...
                <div className="flex flex-row sm:gap-8 gap-4">
                    ...
                    {session ?
                        <Link href='/account' className='text-glow flex flex-col items-center drop-shadow-black hover:drop-shadow-black hover:drop-shadow-md drop-shadow-sm/50 hover:scale-110 transition-all'>
